...
Following results can be reproduced with this document:
  ...
  2. Predicted behavioral classes for gauged catchments in dormant and growing seasons,
  
  3. Performance metrics of trained XGBoost models in dormant and growing seasons over test and training sets of gauged catchments,
  
  4. Regional performance metrics of trained XGBoost model in dormant and growing seasons, and
  
  5. Predicted behavioral classes for ungauged catchments in dormant and growing seasons.
...
### 1.1.2. Predicted Behavioral Classes


### 1.1.3. Training and Test Sets Performance Metrics
...
### 1.1.4. Regional Performance Metrics
...
### 1.2.2. Predicted Behavioral Classes


### 1.2.3. Training and Test Sets Performance Metrics
...
### 1.2.4. Regional Performance Metrics
...
### 2.1.2. Canada (BC) and Salish Sea Region
...
### 2.2.2. Canada (BC) and Salish Sea Region
